...
if  ((wektor[0]*wektor[0])+(wektor[1]*wektor[1])==(wektor[2]*wektor[2])) or ((wektor[2]*wektor[2])+(wektor[1]*wektor[1])==(wektor[0]*wektor[0])) or ((wektor[2]*wektor[2])+(wektor[0]*wektor[0])==(wektor[1]*wektor[1])):
